...
import com.longmai.dbsafe.engine.core.appender.CustomLineFormat;
import com.longmai.dbsafe.engine.core.appender.DbSafeLogger;
import com.longmai.dbsafe.engine.core.appender.MessageFormattingStrategy;
import com.longmai.dbsafe.engine.core.appender.SingleLineFormat;
...
public class DbSafeImplOptions extends StandardMBean implements DbSafeImplLoadableOptions {
    ...
    static {
      ...
      defaults.put(MODULELIST, DbSafeImlFactory.class.getName());
    ...
    public Set<DbSafeFactory> getModuleFactories() {
      return optionsRepository.getSet(DbSafeFactory.class, MODULE_FACTORIES);
    }
    ...
    public void setDriverlist(final String driverlist) {
      ...
      optionsRepository.set(String.class, DRIVERLIST, DbSafeUtil.joinNullSafe(optionsRepository.getSet(String.class, DRIVER_NAMES), ","));
    }
  ...
  public void setDatabaseDialectBooleanFormat(String databaseDialectBooleanFormat) {
    ...
    public void setModulelist(String modulelist) {
      ...
      // setting effective string
      optionsRepository.set(String.class, MODULELIST, DbSafeUtil.joinNullSafe(optionsRepository.getSet(String.class, MODULE_NAMES), ","));
      optionsRepository.setSet(DbSafeFactory.class, MODULE_FACTORIES, modulelist);
    }      
    ...
    @Override
    public DbSafeLogger getAppenderInstance() {
      return optionsRepository.get(DbSafeLogger.class, APPENDER_INSTANCE);
    }
    
    @Override
    public void setAppender(String className) {
      optionsRepository.set(String.class, APPENDER, className);
      optionsRepository.set(DbSafeLogger.class, APPENDER_INSTANCE, className);
    }
