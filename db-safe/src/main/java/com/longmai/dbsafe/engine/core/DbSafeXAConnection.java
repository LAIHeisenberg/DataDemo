...
public class DbSafeXAConnection extends DbSafePooledConnection implements XAConnection {

  public DbSafeXAConnection(PooledConnection connection, JdbcEventListenerFactory jdbcEventListenerFactory) {
