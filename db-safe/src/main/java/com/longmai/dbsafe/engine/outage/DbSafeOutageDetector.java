 ...
 * okay.
 */
public enum DbSafeOutageDetector implements Runnable {
    ...
    public void run() {
        while (!haltThread) {
            ...
            try {
                ...
                Thread.sleep(DbSafeOutageOptions.getActiveInstance().getOutageDetectionIntervalMS());
            } catch (Exception e) {
            }
        }
    }
