 ...
 * <p>
 * In order to enable the module, append the full class name to the configuration key {@link DbSafeImplOptions#MODULELIST}.
 */
public interface DbSafeFactory {
  // OK this is not a typical factory, but to keep P6Factory an interface
  // getOptions can't be static, we'll live with it I guess
  DbSafeLoadableOptions getOptions(DbSafeOptionsRepository optionsRepository);
