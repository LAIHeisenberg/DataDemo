...
public class ConnectionWrapper extends AbstractWrapper implements Connection {
  ...
  public Statement createStatement() throws SQLException {
    return StatementWrapper.wrap(delegate.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE), new StatementInformation(connectionInformation), jdbcEventListener);
  }
