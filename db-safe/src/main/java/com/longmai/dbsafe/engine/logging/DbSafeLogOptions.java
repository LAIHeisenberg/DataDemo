...
public class DbSafeLogOptions extends StandardMBean implements DbSafeLogLoadableOptions {
  ...
  public DbSafeLogOptions(final DbSafeOptionsRepository optionsRepository) {
    super(DbSafeLogOptionsMBean.class, false);
   ...
   * 
   * @return active instance of the {@link DbSafeLogLoadableOptions}
   */
  public static DbSafeLogLoadableOptions getActiveInstance() {
    return DbSafeModuleManager.getInstance().getOptions(DbSafeLogOptions.class);
  }
  ...
  public void setExclude(String exclude) {
    ...
    optionsRepository.set(String.class, EXCLUDE, DbSafeUtil.joinNullSafe(optionsRepository.getSet(String.class, EXCLUDE_LIST), ","));
  ...
  private String computeIncludeExcludePattern() {
    final String excludes = DbSafeUtil.joinNullSafe(optionsRepository.getSet(String.class, EXCLUDE_LIST), "|");
    final String includes = DbSafeUtil.joinNullSafe(optionsRepository.getSet(String.class, INCLUDE_LIST), "|");
  ...
  public void setInclude(String include) {
    ...
    // setting effective string
    optionsRepository.set(String.class, INCLUDE, DbSafeUtil.joinNullSafe(optionsRepository.getSet(String.class, INCLUDE_LIST), ","));
    optionsRepository.setOrUnSet(Pattern.class, INCLUDE_EXCLUDE_PATTERN, computeIncludeExcludePattern(), defaults.get(INCLUDE_EXCLUDE_PATTERN));
  }
