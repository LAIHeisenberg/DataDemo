...
import com.longmai.dbsafe.engine.common.P6Util;
import com.longmai.dbsafe.engine.logging.P6LogFactory;
...
import com.longmai.dbsafe.engine.spy.appender.*;
import com.longmai.dbsafe.engine.spy.option.P6OptionsRepository;
...
public class P6SpyOptions extends StandardMBean implements P6SpyLoadableOptions {
    ...
    static {
      ...
      defaults.put(DATABASE_DIALECT_DATE_FORMAT, "yyyy-MM-dd HH:mm:ss.SSS");
      defaults.put(DATABASE_DIALECT_TIMESTAMP_FORMAT, "yyyy-MM-dd HH:mm:ss.SSS");
