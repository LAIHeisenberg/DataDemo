...
public class DbSafeDataSourceFactory implements ObjectFactory {


  protected static final String DATASOURCE_CLASS_NAME = DbSafeDataSource.class.getName();
  ...
  public Object getObjectInstance(Object refObj,
    ...
    if (className != null && className.equals(DATASOURCE_CLASS_NAME)) {
      ...
      DbSafeDataSource dataSource;
      try {
        dataSource = (DbSafeDataSource) Class.forName(className).newInstance();
      } catch (Exception ex) {
