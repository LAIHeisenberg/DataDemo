...
import com.longmai.dbsafe.engine.logging.DbSafeLogFactory;
import com.longmai.dbsafe.engine.logging.format.BinaryFormat;
import com.longmai.dbsafe.engine.logging.format.HexEncodedBinaryFormat;
import com.longmai.dbsafe.engine.dbsafe.appender.*;
...
public class DbSafeSpyOptions extends StandardMBean implements DbSafeSpyLoadableOptions {
    ...
    static {
      ...
      defaults.put(MODULELIST, DbSafeImlFactory.class.getName() + ","+ DbSafeLogFactory.class.getName());
